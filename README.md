...
[ Salesforce (Closed-Lost) ] --\
                               --> (Zapier Webhook + Sanitizer) --> [ Google Sheets DB ]
[ Zendesk (Solved Tickets) ]  --/                                  (Raw Data Store)
                                                                           |
...
{GEMINI_API_KEY}
SLACK_WEBHOOK_URL
Incoming Webhook URL for Slack channel
{SLACK_WEBHOOK_URL}
...
2. Pipeline Ingestion (Zapier, Salesforce, Zendesk)
...
3. Execution Schedule (Google Apps Script)
